label launchmessage:
    ...
    n "Content warning: spousal/parental abuse, drug abuse, depression, anxiety, and suicide."
    
    nvl clear
    
    n "These topics are very near and dear to us, and it is our intention to treat them with the respect they deserve."
    n "For more information, please go to Resources in the Main Menu."
...
label foreword:
    ...
    n "When we took up this project, we knew that we wanted to focus on these topics, and raise awareness for them, so we made our best effort to tell a story involving them in the right way."
    n "These topics are very near and dear to us, and we do not wish to make light of them."
    n "Some of us may grow up in homes that never have any of these issues. Some parents never fight, some siblings remain clean, and some live a life completely free of mental illness."
    
    nvl clear
                                                           
    n "Yet, as we all know, these issues may apply to our neighbor, or our aunt, or in homes located across the world from us."
    n "These issues aren't caused by bad people, they are caused by bad situations."
    n "These issues are Human issues. They may not happen in all of our homes, but they happen in our neighborhoods, our countries, in our planet… in Our Home."
