label day4s1:
    ...
    play voice "4-1-26.mp3" #potato
    Pro "Sorry, I ran out of materials… I'll be sure to give it a real good fix later."
    "She nods, smiling at me."
    play voice "4-1-27.mp3" #amree
    Sis "I love it, even if it isn't perfect…"
    ##merge between first and second drafts
    play voice "4-1-28.mp3" #kaito
    Mom "Emily! Maria! Are you done over there!?"
    "From out of the corner of our eye, mother calls us to the living room."
    play voice "4-1-29.mp3" #potato
    Pro "Coming, mom!"
    "Maria and I walk over, with her carrying the plushie in her hands ##and trying to keep the tape stuck in place."
    play voice "4-1-30.mp3" #kaito
    ...
    play voice "4-1-60.mp3" #amree
    sis "Guys, please don't fight…"
    play voice "4-1-61.mp3" #kujira
    bro "Not now, Maria!"
    play voice "4-1-62.mp3" #potato
    pro "Hey, don't yell at her, she's got nothing to do with this!"
    play voice "4-1-63.mp3" #kujira
    ...
    play voice "4-1-65.mp3" #kujira
    bro "Go hide in your cave, see if I care!"
    play voice "4-1-66.mp3" #kaito
    ...
    play voice "4-1-69.mp3" #amree
    sis "Um… wh, what happened with you guys."
    play voice "4-1-70.mp3" #potato
    pro "Not today, Maria. I really don't want to talk about it right now…" 
    play voice "4-1-71.mp3" #amree
    sis "I… okay, sorry."
    play voice "4-1-72.mp3" #potato
