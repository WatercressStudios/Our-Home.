label day4s3:
    ...
    "hey em! pls com 2 drama, i rly need ur hALP PLS"
    "ops sry caps!! ^^;"
    ...
    play voice "4-3-6.mp3" #potato
    pro "Hey, Lauren? You wanted me to drop by?"
    play voice "4-3-7.mp3" #potato
    ...
    play voice "4-3-71.mp3" #potato
    pro "...Y-yeah. Same. Thanks, s-see… see you later, okay?"
    play voice "4-3-72.mp3" #starleeter
