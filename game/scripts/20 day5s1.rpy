label day5s1:
    ...
    play voice "5-1-2.mp3" #kujira
    bro "..."
     
    play voice "5-1-3.mp3" #potato
    pro "Yesterday scared the crap out of me, you know."
     
    play voice "5-1-4.mp3" #kujira
    bro "Fuck off."
...
label d5s1bad:
    ...
    play voice "5-1-6.mp3" #kujira
    bro "Then leave me alone."
     
    play voice "5-1-7.mp3" #potato
...
label d5s1good:
    ...
    play voice "5-1-8.mp3" #potato
    pro "Sorry, Alex. I’m just glad to see you’re okay, is all."
     
    play voice "5-1-9.mp3" #kujira
    ...
    play voice "5-1-10.mp3" #potato
    pro "Is something wrong?"
     
    play voice "5-1-11.mp3" #kujira
    bro "I don’t really want to talk about it."
     
    play voice "5-1-12.mp3" #potato
...
label d5s1merged:
    ...
    play voice "5-1-14.mp3" #amree
    sis "Um..."
     
    play voice "5-1-15.mp3" #amree
    sis "Is Alex mad at me?"
     
    play voice "5-1-16.mp3" #potato
    pro "I’m pretty sure he’s mad at everything. What happened?"
     
    play voice "5-1-17.mp3" #amree
