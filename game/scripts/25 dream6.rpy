label dream6:
    ...
    play voice "d6-1-1.mp3" #vivi
    dlov "Hey, baby. What’s going on?"
    play voice "d6-1-2.mp3" #potato
    pro "I…"
    "Something feels weird."
    play voice "d6-1-3.mp3" #vivi
    dlov "Some Clyde been hassling you again?"
    play voice "d6-1-4.mp3" #potato
    pro "No…"
    "How am I here? How is Diane here?"
    play voice "d6-1-5.mp3" #potato
    pro "This… How come you’re so good to me?"
    play voice "d6-1-6.mp3" #vivi
    dlov "Well I’m your best friend, aren’t I?"
    play voice "d6-1-7.mp3" #potato
    pro "Y-yeah."
    play voice "d6-1-8.mp3" #potato
    pro "I just… You’re always here when I need you."
    play voice "d6-1-9.mp3" #vivi
    dlov "So have you been getting trouble? What happened?"
    play voice "d6-1-10.mp3" #potato
    pro "No… My sister…"
    play voice "d6-1-11.mp3" #vivi
    dlov "You don’t have a sister, Emi. Are you sick? Should I get your parents?"
    play voice "d6-1-12.mp3" #potato
    pro "I do…"
    if sleepinroom:
      play voice "d6-1-13.mp3" #potato
      pro "She was sleeping right next to me."
    else:
      play voice "d6-1-14.mp3" #potato
      pro "I just sent her back to her room to sleep."
    "I look around."
    play voice "d6-1-15.mp3" #potato
    pro "Wait… This is like that musical Lauren is doing."
    play voice "d6-1-16.mp3" #vivi
    dlov "Who’s Lauren?"
    play voice "d6-1-17.mp3" #potato
    pro "I’m dreaming."
    play voice "d6-1-18.mp3" #vivi
    dlov "You are?"
    play voice "d6-1-19.mp3" #potato
    pro "I’m definitely dreaming."
    play voice "d6-1-20.mp3" #potato
    pro "You, my family and everything here."
    play voice "d6-1-21.mp3" #potato
    pro "This is all a dream."
    play voice "d6-1-22.mp3" #vivi
    dlov "So what if it is? Nothing wrong with dreams, right?"
    play voice "d6-1-23.mp3" #potato
    pro "I guess not, but... I keep coming back here. Isn’t that weird?"
    play voice "d6-1-24.mp3" #vivi
    dlov "Is it?"
    play voice "d6-1-25.mp3" #potato
    pro "Most people don’t dream the same thing every day."
    play voice "d6-1-26.mp3" #vivi
    dlov "Does it matter?"
    play voice "d6-1-27.mp3" #potato
    pro "I guess… maybe."
    play voice "d6-1-28.mp3" #potato
    pro "And why do I always remember?"
    play voice "d6-1-29.mp3" #vivi
    dlov "Maybe you need to?"
    play voice "d6-1-30.mp3" #potato
    pro "Why?"
    play voice "d6-1-31.mp3" #vivi
    dlov "You tell me, baby."
    play voice "d6-1-32.mp3" #potato
    pro "I guess… I guess I need it."
    play voice "d6-1-33.mp3" #vivi
    dlov "Why?"
    play voice "d6-1-34.mp3" #potato
    pro "I don’t know."
    play voice "d6-1-35.mp3" #vivi
    dlov "Are you sure?"
    play voice "d6-1-36.mp3" #potato
    pro "I’m happy here."
    play voice "d6-1-37.mp3" #vivi
    dlov "Why?"
    play voice "d6-1-38.mp3" #potato
    pro "Because my family's nice to me. Everyone here loves me."
    play voice "d6-1-39.mp3" #vivi
    dlov "I do, Emi. I love you."
    "Diane is so sincere."
    play voice "d6-1-40.mp3" #potato
    pro "Why do you remind me of my sister?"
    play voice "d6-1-41.mp3" #vivi
    dlov "You wanted me to be this way."
    play voice "d6-1-42.mp3" #potato
    pro "Wh-what?"
    play voice "d6-1-43.mp3" #potato
    pro "That would mean I like my sister…"
    "I clutch at my head."
    play voice "d6-1-44.mp3" #potato
    pro "Am I some kind of freak?!"
    "I feel warm hands on top of mine, pulling my hands away from my head so Diane can see my face."
    play voice "d6-1-45.mp3" #vivi
    dlov "Don’t be silly, baby. It’s nothing like that and you know it."
    play voice "d6-1-46.mp3" #vivi
    dlov "You just think she’s easy to talk to."
    play voice "d6-1-47.mp3" #vivi
