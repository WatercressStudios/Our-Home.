label day6s2:
    ...
    "As Lauren pulls into the parking lot, I hang on her words a little bit."
    "What Lauren said right now It's hard to notice, considering she's so upbeat all of the time."
    "I want to ask her about it later. Right now, we have work to do."
    ...
    if yessister:
        ...
        "It's a drug intervention, though, like… it doesn't feel right to force this on her."
...
label brave:
    ...
    show lov happy2 with dissolve
    lov "I'm fine. I've had a pretty cushy life, all things considered."
...
label speechwrite:
    ...
    "Lauren is a great help, helping us rehearse a bit. Feels like a drama production of our own…" 
    "We spend a few hours like this, thinking of what to say and how to say it, but… my mind wanders elsewhere, at times."
    "Every time I look at Lauren, she seems… more mature. She's been through a lot on her own."
    "She doesn't try to give off that impression, but… she carries responsibility well."
    "Why does she gravitate towards me so much, though…? I don't get it. I'm nothing special. Nothing like her."
    "...Oh well. Now's not the time to question it. We're friends, and I'm glad we were able to share this time together."

    scene black with dissolve

    "Once we're satisfied, we agree to head home. Alex is probably already home…"
