label day10s3:
    ...
    play voice "10-3-1.mp3" #potato
    pro "Hey Dad."

    play voice "10-3-2.mp3" #lacTheWatcher
    dad "Hi sweetie. How's your day been?"

    play voice "10-3-3.mp3" #potato
    pro "It's been pretty average so far."

    play voice "10-3-4.mp3" #lacTheWatcher
    dad "Same here."

    play voice "10-3-5.mp3" #potato
    pro "So..."
    ...
    play voice "10-3-7.mp3" #lacTheWatcher
    dad "Yeah, I kn-"

    "-and I interrupt him before he can continue."

    play voice "10-3-8.mp3" #potato
    ...
    play voice "10-3-9.mp3" #lacTheWatcher
    dad "That's true."
    ...
    play voice "10-3-11.mp3" #lacTheWatcher
    ...
    play voice "10-3-12.mp3" #lacTheWatcher
    ...
    play voice "10-3-21.mp3" #lacTheWatcher
    ...
    play voice "10-3-22.mp3" #lacTheWatcher
...
label bloodbonds:
    ...
    play voice "10-3-27.mp3" #lacTheWatcher
    dad "I hate to rely on you three, but it would be for the best."

    play voice "10-3-28.mp3" #lacTheWatcher
    dad "Thank you, Emily."

    play voice "10-3-29.mp3" #potato
...
label atconversationsend:
    ...
    play voice "10-3-42.mp3" #lacTheWatcher
    dad "It's time I go back to work, sweetie. See you soon, okay?"

    play voice "10-3-43.mp3" #potato
    pro "See you."
