...
label brohome1:
    ...
    play voice "10-4-117.mp3" #potato
    ...
    "I didn't hate it!"
    play voice "10-4-118.mp3" #potato
    pro "Alright Alex, it's late, let's get you inside."
    play voice "10-4-119.mp3" #kujira
