...
label reunion:
    ...
    play voice "10-5-20.mp3" #potato
    pro "H-hey, Maria. What's that in your hand…?"

    play voice "10-5-21.mp3" #amree
    sis "Ah? It's… I drew it for you."

    play voice "10-5-22.mp3" #amree
    ...
    play voice "10-5-32.mp3" #amree
    sis "Are we a family again…?"

    play voice "10-5-33.mp3" #potato
    pro "We're getting there… we have each other now."

    play voice "10-5-34.mp3" #kujira
...
label bedtime:
    ...
    play voice "10-5-49.mp3" #potato
    pro "You promise?"

    play voice "10-5-50.mp3" #kujira
    ...
    play voice "10-5-62.mp3" #potato
    pro "Oh, you got your paper all wet…"

    play voice "10-5-63.mp3" #amree
    sis "O-oh…"

    "She continues to ball."

    play voice "10-5-64.mp3" #amree
    ...
    play voice "10-5-65.mp3" #amree
    sis "I-I've been drawing it every morning…"

    play voice "10-5-66.mp3" #potato
    pro "This is why you've been late getting up recently."

    play voice "10-5-67.mp3" #amree
    sis "Yeah… I'm sorry."

    play voice "10-5-68.mp3" #potato
