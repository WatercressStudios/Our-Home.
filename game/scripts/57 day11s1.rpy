label day11s1:
    ...
    voice "11-1-15.mp3" #potato
    pro "...You didn't hear anything about Mom, did you…?"
    
    show dad neutral2 with dissolve

    voice "11-1-16.mp3" #lacTheWatcher
    dad "..."
    voice "11-1-17.mp3" #lacTheWatcher
