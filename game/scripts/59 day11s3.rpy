label day11s3:
    ...
    menu:
        ...
        "Play it cool":
            play voice "11-3-39.mp3" #potato
            pro "Thanks."
            play voice "11-3-40.mp3" #starleeter
            lov "Of course. That’s what friends are for, right?"
            "I nod."
            play voice "11-3-41.mp3" #potato
            pro "Yeah…"
    ...
    play voice "11-3-47.mp3" #starleeter
    lov "Not to worry! I’ll cover for you."
    play voice "11-3-48.mp3" #potato
    pro "Thanks, Lauren."
