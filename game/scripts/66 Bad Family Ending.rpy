label badFamilyEnding:
    ...
    #Some sort of transition effect here. 'Flashback' ends.

    "I remember how his words lingered in the air, and I remember waiting for the response that never came."
    ...
    "It's been tough, without her. Better, in some ways… but you can never really know if this 'better' is better than the alternative."
