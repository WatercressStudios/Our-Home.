label superBadEnding:
    ...
    play ambience kmart fadein (2.0)
    scene kmart with Dissolve(2.0)
    ...
    "I clench my jaw. It's the same thing every time."
    
    scene hallway with dissolve     
    scene brodoor with dissolve     
    "I march angrily to my brother's room and pound on his door."
    ...
    "The table becomes silent after that. No one else says a word for the rest of the dinner."
